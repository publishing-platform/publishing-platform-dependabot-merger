...
RSpec.describe PolicyManager do
  ...
  describe "#dependency_policy" do
    ...
    let(:internal_dependency) { stub_internal_dependency("publishing_platform_publishing_components") }
  ...
  def stub_internal_dependency(dependency_name)
    stub_request(:get, "https://rubygems.org/api/v1/gems/#{dependency_name}/owners.yaml").to_return(
      status: 200,
      body: "- id: 192816", # publishing platform team ID on rubygems.org
    )
    dependency_name
  end
  ...
  def stub_external_dependency(dependency_name)
    stub_request(:get, "https://rubygems.org/api/v1/gems/#{dependency_name}/owners.yaml").to_return(
      status: 200,
      body: "- id: 123456", # some random non-publishing-platform team ID on rubygems.org
    )
    dependency_name
  end
end
